package net.helmi.springobservabilitygrafana;
...
public class SpringObservabilityGrafanaApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringObservabilityGrafanaApplication.class, args); }
